			...
			value: function render() {
				...
				var squares = this.props.tracks.payload.results.sort(function (a, b) {
					...
					if (r.collectionName.toLowerCase().indexOf(filterAlbum.toLowerCase()) !== -1 && r.artistName.toLowerCase().indexOf(filterArtist.toLowerCase()) !== -1) {
						var trackclass = that.state.track && that.state.track.index === index ? _AlbumsView2.default['track--selected'] : '';
						return React.createElement(
							'div',
							{ className: _AlbumsView2.default['track'] + ' ' + trackclass, onClick: _this2.chooseTrack.bind(_this2, { t: r, index: index }) },
							React.createElement(
								'div',
								{ className: 'text' },
								React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".AlbumsView__track___2xYsx{margin:3px}.AlbumsView__track--selected___6g7ml{color:#6fb3d2}", "", {"version":3,"sources":["/./src/views/AlbumsView.scss"],"names":[],"mappings":"AAAA,2BACE,UAAY,CAAE,qCAGd,aAAe,CAAE","file":"AlbumsView.scss","sourcesContent":[".track {\n  margin: 3px; }\n\n.track--selected {\n  color: #6FB3D2; }\n"],"sourceRoot":"webpack://"}]);
...
//# sourceMappingURL=app.44605ab6b97525aa1b5f.js.map